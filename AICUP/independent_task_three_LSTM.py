...
class ActionModel(nn.Module):
    def __init__(self, num_tokens_per_feature, n_act, emb_dim=16, hidden=512, num_layers=3, dropout=0.2):
        super().__init__()
...
def main(args):
    ...
    scheduler_A = lr_scheduler.StepLR(opt_A, step_size=5, gamma=0.5)
    scheduler_R = lr_scheduler.StepLR(opt_R, step_size=5, gamma=0.5)
